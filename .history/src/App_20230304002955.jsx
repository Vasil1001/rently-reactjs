...
function App() {
  return (
    <>
      <Router>
        <div className="flex flex-col min-w-screen min-h-screen h-screen-vh content-center items-center justify-self-center justify-items-center text-white dark:bg-[#1a1b1e]">
          <Navbar />
