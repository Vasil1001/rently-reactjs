...
export default function ListingItem({ listing, id, onDelete, onEdit }) {
  return (
    <div className="mb-5 overflow-hidden rounded-lg min-h-96 max-h-96">
      <div className="grid grid-cols-5 ">
        <div className="relative pb-5 h-auto min-h-96 max-h-96 w-full  bg-slate-100 col-span-full md:col-span-2 lg:col-span-2 xl:col-span-2 ">
          <img
