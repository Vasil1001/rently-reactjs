    ...
    <div>
      ...
      <Link to={`/category/${listing.type}/${id}`}>
        <div className="grid grid-cols-4 col-span-4 mb-5  ">
          ...
          <div className="flex col-span-4 gap-2 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4 ">
            <div className="card col-span-1 grow bg-[#1a1b1e] gap-2 lg:col-span-2 md:col-span-2 ">
              <img
                ...
                alt={listing.name}
                className=" object-fill rounded-lg rounded-tl-lg xl:rounded-l-xl lg:rounded-l-xl md:rounded-l-xl sm:rounded-tl-lg  h-min-44 h-44"
              />
            </div>
          ...
          <div className="flex flex-col col-span-4 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4 p-3 px-4 bg-slate-100 shadow-xl justify-between text-black flex-auto overflow-hidden xl:rounded-br-xl lg:rounded-br-xl md:rounded-br-xl sm:rounded-br-xl xl:rounded-bl-none lg:rounded-bl-none md:rounded-bl-none sm:rounded-bl-xl md:rounded-tr-xl sm:rounded-bl-xl">
