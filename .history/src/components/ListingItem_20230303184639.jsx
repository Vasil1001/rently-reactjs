...
export default function ListingItem({ listing, id, onDelete, onEdit }) {
  return (
    <div className="mb-10 bg-red-500 overflow-hidden rounded-lg">
        <div className="relative mb-10 pb-5 h-80 min-h-80 max-h-96 w-full  bg-slate-100 col-span-full md:col-span-2 lg:col-span-2 xl:col-span-2 ">
          <img
        ...
        <div className="col-span-full bg-slate-100 p-6 md:col-span-3 lg:col-span-3 xl:col-span-3">
...
<div className="mb-5 overflow-hidden rounded-lg">
      <div className="grid grid-cols-5 ">
        <div className="relative pb-5 h-80 min-h-80 max-h-96 w-full  bg-slate-100 col-span-full md:col-span-2 lg:col-span-2 xl:col-span-2 ">
          <img
            className="absolute bottom-0 h-full w-full object-cover"
            src={listing.imgUrls[0]}
            alt="image"
