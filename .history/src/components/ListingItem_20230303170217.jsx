    ...
    <div className="  overflow-hidden rounded-lg border">
      ...
      <div className="p-6">
        <div className="flex items-baseline">
          <span className="inline-block rounded-full bg-teal-200 px-2 text-xs text-teal-800">NEW</span>
          <div className="ml-2 text-xs font-semibold uppercase tracking-wide text-gray-600 bg-slate-100">
