    ...
    <div className="navbar bg-base-300">
      <div className="navbar-start">
        <div className="dropdown block xl:hidden lg:hidden md:block sm:block">
          ...
          <ul
            tabIndex={0}
            className="menu dropdown-content compact mt-4 p-2 shadow-2xl bg-base-100 rounded-box w-52"
          >
            <li>
              <a
                className={
      ...
      <div className="navbar-end">
        <div className="dropdown dropdown-end">
          ...
          <ul
            tabIndex={0}
            className="menu menu-compact menu dropdown-content compact mt-4 p-2 shadow-2xl bg-base-100 rounded-box w-52 mt-3 p-2 shadow bg-base-100 rounded-box w-52"
          >
            <li>
              <a
                className={
