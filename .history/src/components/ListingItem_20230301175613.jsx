    ...
    <div>
      ...
      <Link to={`/category/${listing.type}/${id}`}>
        <div className="grid grid-cols-4 col-span-4 mb-5  ">
          ...
          <div className="flex col-span-4 gap-2 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4">
            <div className="card col-span-1 grow bg-[#1a1b1e] gap-2 lg:col-span-2 md:col-span-2 ">
              <img
                ...
                alt={listing.name}
                className=" object-fill rounded-l-xl h-min-56 h-56"
              />
            </div>
          ...
          <div className="flex flex-col relative rounded-r-xl col-span-4 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4 p-3 bg-slate-100 shadow-xl justify-between text-black flex-auto overflow-hidden  ">
          ...
          <div className="absolute bottom-110 right-110 bg-slate-100">
            {onDelete && (
              <DeleteIcon
                className="w-7 h-7 absolute top-100 "
                fill="rgb(231, 76,60)"
