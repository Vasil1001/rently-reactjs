  ...
  return (
    <div className="mb-5 overflow-hidden rounded-lg">
      <div className="grid grid-cols-8 ">
        <div className="relative col-span-full h-80 w-full bg-slate-100 pb-5 sm:h-80 md:col-span-2 md:h-72 lg:col-span-2 lg:h-72 xl:col-span-1 xl:h-72 ">
        ...
        <div className="col-span-full flex flex-col justify-between bg-slate-100  p-6 text-lg text-gray-900 md:col-span-3 lg:col-span-3 xl:col-span-4">
          <Link to={`/category/${listing.type}/${id}`}>
          ...
          <div className=" ">
            <div className="flex items-baseline ml-2 text-xs font-bold uppercase tracking-wide text-gray-700 ">
