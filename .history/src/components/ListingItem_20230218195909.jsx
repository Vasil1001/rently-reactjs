  ...
  return (
    <li>
      ...
      <div className="grid grid-cols-4 col-span-4 mb-2 ">
        ...
        <div className="flex col-span-2 md:col-span-1 sm:col-span-1 gap-2 ">
        ...
        <div className="flex flex-col col-span-2 md:col-span-1 sm:col-span-1 p-3 bg-slate-100 shadow-xl  justify-between text-black">
