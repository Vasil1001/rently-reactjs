...
export default function ListingItem({ listing, id, onDelete, onEdit }) {
  return (
    <div className="mb-5 overflow-hidden rounded-lg border border-2 border-gray-600">
      <div className="grid grid-cols-5">
        <div className="relative h-80 w-full  bg-slate-100 col-span-full md:col-span-2 lg:col-span-2 xl:col-span-2 ">
          <img
        ...
        <div className="min-h-64 col-span-full bg-slate-100 p-6 md:col-span-3 lg:col-span-3 xl:col-span-3">
