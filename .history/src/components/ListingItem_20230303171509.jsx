...
export default function ListingItem({ listing, id, onDelete, onEdit }) {
  return (
    <div className="  h-screen-vh min-h-vh mb-5 overflow-hidden rounded-lg border border-2 border-gray-600">
        ...
        <div className="flex items-baseline ">
          <div className="ml-2 text-xs font-bold uppercase tracking-wide text-gray-700 ">
            <div className="text-md flex gap-1">
              ...
              <p className="mr-4 mt-1 hidden md:block lg:block xl:block">
              ...
              <p className="mr-2 mt-1 hidden md:block lg:block xl:block">
