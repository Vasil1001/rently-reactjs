    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <a onClick={() => navigate('/explore')} className="btn btn-ghost normal-case text-lg">explore</a>
                <a onClick={() => navigate('/offers')} className="btn btn-ghost normal-case text-lg">Offers</a>
                <a onClick={() => navigate('/profile')} className="btn btn-ghost normal-case text-lg">Offers</a>
