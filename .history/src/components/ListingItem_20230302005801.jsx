          ...
          <div className="flex col-span-4 gap-2 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4">
            ...
            <div className="col-span-1 ">
              <img
                ...
                alt={listing.name}
                className=" object-fill h-min-44 h-44 xl:block lg:block md:block rounded-tr-xl xl:rounded-r-none lg:rounded-r-none md:rounded-r-none sm:rounded-tr-none xl:rounded-tr-xl lg:rounded-tr-xl md:rounded-tr-xl"
              />
            </div>
          </div>
