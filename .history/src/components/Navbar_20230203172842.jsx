    ...
    return (
        <div className="navbar bg-base-300">
            <div className="navbar-start">
                ...
                <a onClick={() => navigate('/')} className={pathMatchRoute('/') ? 'bg-[#434854] btn btn-link normal-case text-lg text-white mx-3 hover:bg-[#636a7e]' : 'bg-base-300 btn btn-ghost normal-case text-lg'}>Explore</a>
