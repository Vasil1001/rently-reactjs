  ...
  return (
    <li>
      ...
      <div className="grid grid-cols-4 col-span-4 mb-3 xl:mb-3 lg:mb-3 md:mb-2 sm:mb-2 ">
        ...
        <div className="flex flex-col col-span-3 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-1 p-3 bg-slate-100 shadow-xl justify-between text-black truncate">
