  ...
  return (
    <div>
      ...
      <Link to={`/category/${listing.type}/${id}`}>
        <div className="grid grid-cols-4 col-span-4 mb-3  ">
          ...
          <div className="flex flex-col rounded-r-xl col-span-4 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4 p-3 bg-slate-100 shadow-xl justify-between text-black flex-auto overflow-hidden  ">
          ...
          {onDelete && (
            <DeleteIcon
              className="w-7 h-7 absolute  top-[120px] right-14"
              fill="rgb(231, 76,60)"
