    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <a onClick={() => navigate('/explore')} className="btn btn-ghost normal-case text-lg" fill={pathMatchRoute('/') ? '#fec826' : '#fec826'}>Explore</a>
                ...
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu  dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <li><a onClick={() => navigate('/explore')}>
                            <ExploreIcon fill={pathMatchRoute('/') ? '#2c2c2c' : '#8f8f8f'} width='2em' height='2em' />Explore
                        </a></li>
