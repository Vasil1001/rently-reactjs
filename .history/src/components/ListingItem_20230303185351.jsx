...
export default function ListingItem({ listing, id, onDelete, onEdit }) {
  return (
    <div className="mb-5 bg-red-500 overflow-hidden rounded-lg">
        <div className="relative pb-2 h-44 max-h-96">
          <img
            className="absolute h-full w-full bottom-0 object-cover"
