    ...
    <div>
      ...
      <div className="col-span-4 mb-5 grid  grid-cols-4  ">
        ...
        <div className="col-span-4  flex gap-2 sm:col-span-4 md:col-span-2 lg:col-span-2 xl:col-span-2 ">
          <div className="card col-span-2 grow gap-2 bg-[#1a1b1e] sm:col-span-2 md:col-span-2 lg:col-span-2">
            <img
          ...
          <div className="sm:col-span-0 col-span-1 sm:hidden">
            <img
              src={listing.imgUrls[1]}
              alt={listing.name}
              className="h-min-44 h-44 rounded-tr-xl object-fill sm:hidden sm:rounded-tr-xl md:block md:rounded-r-none lg:block lg:rounded-r-none xl:block xl:rounded-r-none"
            />
          </div>
        </div>
