    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <a onClick={() => navigate('/')} className={pathMatchRoute('/') ? 'bg-[#f7024d] btn btn-primary normal-case text-lg text-white' : 'bg-[#2a303c] btn btn-ghost normal-case text-lg' }>Explore</a>
