    ...
    <div>
      ...
      <Link to={`/category/${listing.type}/${id}`}>
        <div className="grid grid-cols-4 col-span-4 mb-5  ">
          ...
          <div className="flex flex-col relative rounded-r-xl col-span-4 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4 p-3 px-4 bg-slate-100 shadow-xl justify-between text-black flex-auto overflow-hidden  ">
          ...
          <div className="flex gap-3 absolute right-10 mt-2">
            {onEdit && (
              <EditIcon
                className="w-7 h-7"
                fill="rgb(260, 170, 60)"
            ...
            {onDelete && (
              <DeleteIcon
                className="w-7 h-7 sm:w-5 sm:h-3"
                fill="rgb(231, 30, 60)"
