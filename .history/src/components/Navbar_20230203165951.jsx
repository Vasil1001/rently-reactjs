...
export default function Navbar() {
    ...
    return (4a4f5e
        <div className="navbar bg-base-100">
            ...
            636a7e
                <a onClick={() => navigate('/')} className={pathMatchRoute('/') ? 'bg-[#636a7e] btn btn-link normal-case text-lg text-white mx-2 hover:bg-[#4a4f5e]' : 'bg-[#2a303c] btn btn-ghost normal-case text-lg' }>Explore</a>
