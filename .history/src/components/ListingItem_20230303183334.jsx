  ...
  return (
    <div className="h-screen-vh mb-5 overflow-hidden rounded-lg border border-2 border-gray-600">
      <div className="grid grid-cols-5">
        <div className="relative col-span-full bg-slate-100 col-span-full md:col-span-2 lg:col-span-2 xl:col-span-2 ">
          <img
            className="absolute bottom-0 min-h-80 h-80 w-full object-cover"
