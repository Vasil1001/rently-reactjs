        ...
        <div className="col-span-4  flex gap-2 sm:col-span-4 md:col-span-2 lg:col-span-2 xl:col-span-2 ">
          ...
          <div className="col-span-1 ">
            <img
              ...
              alt={listing.name}
              className="sm:hidden min-w-full  h-44 rounded-tr-xl object-fill sm:rounded-tr-xl md:block md:rounded-r-none lg:block lg:rounded-r-none xl:block xl:rounded-r-none"
            />
          </div>
        </div>
