    ...
    <div className="navbar bg-base-300">
      <div className="navbar-start">
        <div className="dropdown ">
          <label tabIndex={0} className="btn btn-ghost btn-circle hidden md:block  sm:inline">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 md:block"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <ul
            tabIndex={0}
            className="menu  dropdown-content compact mt-3 p-2 shadow bg-base-100 rounded-box w-52"
          >
            <li>
              <a
                className={
