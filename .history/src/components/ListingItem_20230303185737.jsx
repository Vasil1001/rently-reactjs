  ...
  return (
    <div className="mb-5 overflow-hidden rounded-lg">
      <div className="grid grid-cols-5 ">
        <div className="relative pb-5 sm:h-80 sm:h-80 sm:h-80 sm:h-80h-80 min-h-80 max-h-96 w-full  bg-slate-100 col-span-full md:col-span-2 lg:col-span-2 xl:col-span-2 ">
          <img
