            ...
            <div className="navbar-start">
                <div className="dropdown ">
                    ...
                    <ul tabIndex={0} className="menu dropdown-content  mt-3 p-2 shadow bg-base-300 rounded-box w-52">
                        <li><a className={pathMatchRoute('/') ? 'bg-[#4a4f5e] hover:bg-[#636a7e] mb-2' : ' mb-2 bg-base-300 hover:bg-[#3b414a]'} onClick={() => navigate('/')} >
                            <ExploreIcon fill={pathMatchRoute('/') ? '#fec826' : '#9f9f9f'} width='2em' height='2em' />
                            <p >Explore</p>
                        </a></li>
                        <li><a className={pathMatchRoute('/offers') ? 'bg-[#4a4f5e] hover:bg-[#636a7e] my-2' : ' my-1 bg-base-300 hover:bg-[#3b414a]'} onClick={() => navigate('/offers')}>
                            <OfferIcon fill={pathMatchRoute('/offers') ? '#fec826' : '#9f9f9f'} width='2em' height='2em' />
                            Offers
                        </a></li>
                        <li><a className={pathMatchRoute('/profile') ? 'bg-[#4a4f5e] hover:bg-[#636a7e] mt-2' : 'mt-1 bg-base-300 hover:bg-[#3b414a]'} onClick={() => navigate('/profile')}>
