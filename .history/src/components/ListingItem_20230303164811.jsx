...
export default function ListingItem({ listing, id, onDelete, onEdit }) {
  return (
    <div className="  border rounded-lg overflow-hidden">
      {/* <div className="h-48 bg-cover bg-center" style={{backgroundImage: `url('${listing.imgUrls[0]})`}}></div> */}
      <img className="w-full h-48 object-cover" src={listing.imgUrls[0]} alt="image"  />

      <div className="p-6"><div className="flex items-baseline"><span className="inline-block bg-teal-200 text-teal-800 text-xs px-2 rounded-full"></span></div></div>
