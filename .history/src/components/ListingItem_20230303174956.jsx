  ...
  return (
    <div className="h-screen-vh mb-5 overflow-hidden rounded-lg border border-2 border-gray-600">
      <div className="grid grid-cols-5">
        <div className="col-span-full xl:col-span-2 md:col-span-2 lg:col-span-2 ">
          <img
        ...
        <div className="col-span-full xl:col-span-3 md:col-span-2 lg:col-span-2 min-h-48 bg-slate-100 p-6">
