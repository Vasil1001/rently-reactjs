  ...
  return (
    <div className="h-screen-vh mb-5 overflow-hidden rounded-lg border border-2 border-gray-600">
      <div className="grid grid-cols-5">
        <div className="relative pb-1 h-64 w-full object-cover bg-slate-100 col-span-full md:col-span-2 lg:col-span-2 xl:col-span-2 ">
          <img
            className="absolute bottom-0 min-h-64 max-h-64 w-full object-cover"
            src={listing.imgUrls[0]}
            alt="image"
          />
        </div>

        <div className="min-h-48 col-span-full bg-slate-100 p-6 md:col-span-3 lg:col-span-3 xl:col-span-3">
