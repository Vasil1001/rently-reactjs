    ...
    <div className="navbar bg-base-300">
              ...
              <a
                className={
                  pathMatchRoute("/")
                    ...
                    : " mb-1 bg-base-300 hover:bg-[#3b414a]"
                }
                onClick={() => navigate("/")}
              >
                <ExploreIcon
              ...
              <a
                className={
                  pathMatchRoute("/offers")
                    ...
                    : " my-1 bg-base-300 hover:bg-[#3b414a]"
                }
              ...
              <a
                className={
                  pathMatchRoute("/profile")
                    ...
                    : "mt-1 bg-base-300 hover:bg-[#3b414a]"
                }
      ...
      <div className="navbar-end">
        <div className="dropdown dropdown-end">
          ...
          <ul
            tabIndex={0}
            className="menu menu-compact mt-3 p-2 dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52"
          >
            <li>
              <a
                className={
            ...
            <a
                className={
                  pathMatchRoute("/")
                    ? "bg-[#4a4f5e] hover:bg-[#636a7e] mb-1"
                    : " mb-1 bg-base-300 hover:bg-[#3b414a] active:bg-[#7e3838]"
                }
                onClick={() => navigate("/login")}
              >
                Logout
