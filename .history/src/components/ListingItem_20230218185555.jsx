...
export default function ListingItem({ listing, id, onDelete }) {
  return (
    <li>
      <div className="grid grid-cols-4 col-span-4"> {/* ? Left 50% half, with space for 2 Images */}
        ...
        {/* ? Right 50% half, with Title and Description */}
        <div className="col-span-2 bg-slate-300">TEXT</div>
