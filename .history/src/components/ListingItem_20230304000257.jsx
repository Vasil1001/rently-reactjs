  ...
  return (
    <div className="mb-5 overflow-hidden rounded-lg">
      <div className="grid grid-cols-5 ">
        <div className="relative col-span-full h-80 w-full bg-slate-100 pb-5 sm:h-80 md:col-span-2 md:h-72 lg:col-span-2 lg:h-72 xl:col-span-2 xl:h-72 ">
            ...
            >
              {listing.imgUrls.map((url, index) => {
                ...
                <div className=" overflow-hidden rounded-lg">
                  <div className="relative col-span-full  min-h-[18rem]  w-full bg-slate-100 pb-5">
                    <img
                      className="absolute bottom-0 min-h-full self-center no-repeat w-full object-cover"
        ...
        <div className="col-span-full flex flex-col justify-between bg-slate-100  p-6 text-lg text-gray-900 md:col-span-3 lg:col-span-3 xl:col-span-3">
          <Link to={`/category/${listing.type}/${id}`}>
          ...
          <div className="flex items-baseline text-xs font-bold uppercase tracking-wide text-gray-700 ">
            <div className="text-md flex gap-1">
              <img src={bedIcon} alt="bed" />
              <p className="mt-1 overflow-hidden text-lg">
          ...
          <div className="absolute right-10 mt-0 flex  cursor-pointer gap-3 ">
            {onEdit && (
              <EditIcon
                className="h-6 w-6 "
                fill="rgb(250, 150, 60)"
