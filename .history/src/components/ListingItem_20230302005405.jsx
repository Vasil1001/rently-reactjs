          ...
          <div className="flex col-span-4 gap-2 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4">
            ...
            <div className="col-span-1 ">
              <img
                ...
                alt={listing.name}
                className=" object-fill h-min-44 h-44 xl:block lg:block md:block rounded-tr-xl xl:rounded-r-xl lg:rounded-r-lg md:rounded-r-lg sm:rounded-tr-lg"
              />
            </div>
          </div>

          {/* ? Right 50% half, with Title, Description, Price, Beds, Bathrooms */}
          <div className="flex flex-col col-span-4 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4 p-3 px-4 bg-slate-100 shadow-xl justify-between text-black flex-auto overflow-hidden rounded-bl-lg xl:rounded-br-lg lg:rounded-br-lg md:rounded-br-lg sm:rounded-br-lg ">
