  ...
  return (
    <li>
      ...
      <div className="grid grid-cols-4 col-span-4 mb-3 xl:mb-3 lg:mb-3 md:mb-2 sm:mb-2 ">
          ...
          <div className="col-span-1 ">
            <Link to={`/category/${listing.type}/${id}`}>
              <img
                ...
                alt={listing.name}
                className="block object-fill h-min-56 h-56 xl:block lg:object-fill md:object-fill sm:hidden"
              />
            </Link>
          </div>
        </div>
        ...
        <div className="flex flex-col col-span-2 p-3 bg-slate-100 shadow-xl justify-between text-black truncate">
