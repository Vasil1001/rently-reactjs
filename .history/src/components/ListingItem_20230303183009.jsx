...
export default function ListingItem({ listing, id, onDelete, onEdit }) {
  return (
    <div className="">
      <div className="h-screen-vh relative col-span-full grid h-full h-96 w-full grid-cols-5 overflow-hidden rounded-lg border border-2  border-gray-600 bg-slate-100 md:col-span-2 lg:col-span-2 xl:col-span-2 ">
        <img
