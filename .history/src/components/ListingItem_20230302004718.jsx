    ...
    <div>
      ...
      <Link to={`/category/${listing.type}/${id}`}>
        <div className="grid grid-cols-4 col-span-4 mb-5  ">
          ...
          <div className="flex flex-col rounded-r-xl col-span-4 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4 p-3 px-4 bg-slate-100 shadow-xl justify-between text-black flex-auto overflow-hidden  ">
            ...
            <div className="flex gap-3 absolute right-10  mt-0 ">
              {onEdit && (
                <EditIcon
                  className="w-6 h-6 xl:w-6 xl:h-6 lg:w-6 lg:h-6 md:w-6 md:h-6 sm:w-6 sm:h-6"
                  fill="rgb(260, 170, 60)"
                  onClick={() => onEdit(id)}
                />
              )}
              {onDelete && (
                <DeleteIcon
                  className="w-6 h-6 xl:w-7 xl:h-7 lg:w-6 lg:h-6 md:w-6 md:h-6 sm:w-6 sm:h-6"
                  fill="rgb(231, 30, 60)"
