            ...
            <div className="navbar-start">
                ...
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu  dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <li className='pathMatchRoute('/explore') ? '#fec826' : '#9f9f9f'} bg-[#756c52]'><a onClick={() => navigate('/explore')}>
                            <ExploreIcon fill={pathMatchRoute('/explore') ? '#fec826' : '#9f9f9f'} width='2em' height='2em' />Explore
                        </a></li>
