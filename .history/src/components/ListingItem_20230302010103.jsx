    ...
    <div>
      ...
      <Link to={`/category/${listing.type}/${id}`}>
        <div className="grid grid-cols-4 col-span-4 mb-5  ">
          ...
          <div className="flex flex-col col-span-4 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4 p-3 px-4 bg-slate-100 shadow-xl justify-between text-black flex-auto overflow-hidden xl:rounded-br-xl lg:rounded-br-xl md:rounded-br-xl sm:rounded-br-xl xl:rounded-bl-xl lg:rounded-bl-none md:rounded-bl-none sm:rounded-bl-xl ">
