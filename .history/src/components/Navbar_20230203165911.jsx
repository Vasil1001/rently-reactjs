    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <a onClick={() => navigate('/')} className={pathMatchRoute('/') ? 'bg-[#4a4f5e] btn btn-link normal-case text-lg text-white mx-2' 'bg-[#2a303c] btn btn-ghost normal-case text-lg' }>Explore</a>
