    ...
    <div>
      ...
      <Link to={`/category/${listing.type}/${id}`}>
        <div className="grid grid-cols-4 col-span-4 mb-5  ">
          ...
          <div className="flex flex-col relative rounded-r-xl col-span-4 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-4 p-3 bg-gray-200 shadow-xl justify-between text-black flex-auto overflow-hidden  ">
