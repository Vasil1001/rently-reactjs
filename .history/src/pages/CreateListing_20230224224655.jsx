  ...
  return (
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto xl:w-10/12 lg:w-12/12 md:w-12/12 mt-5">
      ...
      <form onSubmit={onSubmit} className="flex flex-col">
        ...
        <div className="flex mt-4 justify-between content-center items-end">
          <div>
            <label>
              <b>Images</b>
            </label>
          ...
          <div className="items-end">
            <button
              className="items-end px-3 py-2 border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400 bg-orange-600 hover:bg-orange-700"
              type="number"
              id="longitude"
              value={longitude}
              onChange={onMutate}
        ...
        <div className="flex justify-between ">
          <div></div>
          <button
            className=" px-3 py-2 border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400 bg-orange-600 hover:bg-orange-700"
            type="number"
            id="longitude"
            value={longitude}
            onChange={onMutate}
