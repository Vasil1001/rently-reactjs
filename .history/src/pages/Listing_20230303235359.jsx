          ...
          {listing.imgUrls.map((url, index) => {
            return (
              ...
              <div className="mb-5 overflow-hidden rounded-lg">
                ...
                <div className="relative h-[400px] min-h-[40rem] bg-red-500 col-span-full  h-96 w-full bg-slate-100 pb-5">
                  <img
                    className="absolute h-[400px] min-h-[40rem] bottom-0 w-full object-cover"
