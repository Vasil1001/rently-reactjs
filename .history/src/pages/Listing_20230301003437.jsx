      ...
      <div className="grid grid-cols-5 p-2 gap-2 ">
        <div className="col-span-5">
          ...
          <div className="flex flex-col">
            <h1 className="text-gray-300 text-sm">Bedrooms</h1>
            <span className="flex gap-3">
            <img src={bedIcon} alt="bed" style={{ filter: "invert(91%) " }} />
              {listing.bedrooms > 1
                ? `${listing.bedrooms} `
                : `${listing.bedrooms} `}
            </span>
          ...
          <div className="flex gap-5 ju">
            <div className="stats"><div className="stat">asdf</div></div>
            <div className="stats"><div className="stat">asdf</div></div>
            <div className="stats"><div className="stat">asdf</div></div>
          </div>
          <ul>
