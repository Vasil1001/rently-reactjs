          ...
          {listing.imgUrls.map((url, index) => {
            return (
              ...
              <div className="mb-5 overflow-hidden rounded-lg">
                ...
                <div className="relative h-[400px] min-h-[30rem] bg-red-500 col-span-full  h-96 w-full bg-slate-100 pb-5">
                  <img
                    className="absolute h-[300px] min-h-[30rem] bottom-0 w-full object-cover"
