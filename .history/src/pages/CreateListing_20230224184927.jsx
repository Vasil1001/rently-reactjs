  ...
  return (
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto xl:w-10/12 lg:w-12/12 md:w-12/12 mt-5">
      ...
      <form onSubmit={onSubmit} className="flex flex-col">
        ...
        <label className="text-sm mb-1">Include as many details as possible, eg. 2 Bedroom Flat, Location, Price</label>
        <input
        ...
        <p className="text-sm mb-3">The first image will be the cover (max 6).</p>
        <input
          className="p-2 mt-6 w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400 bg-orange-700 hover:bg-orange-600"
          type="file"
          id="images"
          onChange={onMutate}
          max="6"
