      ...
      <div className="grid grid-cols-5 p-2 gap-2 ">
        <div className="col-span-3">
          ...
          <div>
            ...
            <span className="badge badge-accent ">{listing.type === "rent" ? "Rent" : "Sale"}</span>
            
            <span className="rounded-xl bg-green-700 p-1 px-2 text-sm ">{listing.type === "rent" ? "Rent" : "Sale"}</span>
            {listing.offer && (
