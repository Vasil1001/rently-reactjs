...
export default function Listing() {
  ...
  return (
    <div className="rounded-lg mx-auto w-12/12 xl:w-9/12 lg:w-12/12 md:w-12/12 sm:w-12/12 mt-5">
      ...
      <div className="grid grid-cols-5 pt-3 ">
        <div className="col-span-5">
          <div className="flex justify-between">
            ...
            >
              <div className="flex">
                {shareLinkCopied && <p className="mr-16 hidden xl:block lg:block md:block sm:hidden">Link Copied!</p>}
                <img
                  src={shareIcon}
                  alt="Share Icon"
      ...
      {/* MAP */}
      <div className="bg-slate-700 w-52 mt-3 p-3  text-lg font-bold rounded text-center hover:bg-skate">
