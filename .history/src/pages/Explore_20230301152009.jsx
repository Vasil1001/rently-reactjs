          ...
          <div className="p-6 text-center">
            <div className="max-w-full">
              ...
              <input
                ...
                className="input bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 focus:bg-white focus:border-gray-500 bg-slate-100 w-full max-w-md"
              />
            </div>
          </div>
        </div>
