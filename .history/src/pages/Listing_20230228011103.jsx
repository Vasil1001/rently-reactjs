...
export default function Listing() {
  ...
  return (
    <div className="rounded-lg  mx-auto xl:w-9/12 lg:w-12/12 md:w-12/12 mt-5">
      ...
      >
        <img src={shareIcon} alt="Share Icon" style={{filter: "invert(91%) sepia(99%) saturate(5630%) hue-rotate(246deg) brightness(111%) contrast(148%)"}}  className="text-white stroke-white"/>
      </div>
