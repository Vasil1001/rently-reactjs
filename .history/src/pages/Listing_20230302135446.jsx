    ...
    <div className="rounded-lg  mx-auto xl:w-9/12 lg:w-12/12 md:w-12/12 sm:w-12/12 mt-5">
      ...
      <div className="mx-auto ">
        <span className="flex items-center mb-3 " onClick={() => navigate(-1)}>
          ...
          <p className="text-md tracking-wide cursor-pointer">
            Back to listings
          </p>
        </span>
      ...
      >
        ...
        <section className="h-full">
          <div className="flex flex-wrap ">
            ...
            <div className="h-[300px] min-h-[30rem] md:w-2/5 mb-2">
              <div
                  className="h-[150px] min-h-[14rem] w-full bg-cover rounded shadow-md pb-2"
                  style={{
                    backgroundImage:
                      `url(${listing.imgUrls[0]})`,
                  }}
                ...
                <div
                  className="h-[150px] min-h-[14rem] w-full bg-cover rounded shadow-md"
                  style={{
                    backgroundImage:
                      `url(${listing.imgUrls[0]})`,
                  }}
      ...
      {auth.currentUser?.uid !== listing.userRef && (
        <div className="bg-slate-700 w-52 mt-4 p-3  text-lg font-bold rounded text-center hover:bg-slate-600">
          <Link
