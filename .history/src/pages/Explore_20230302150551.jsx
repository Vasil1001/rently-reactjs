...
export default function Explore() {
  return (
    <div className="pt-5 mx-auto xl:w-10/12 lg:w-12/12 md:w-12/12 sm:w-12/12  w-full vh-screen">
      ...
      <h1 className="text-3xl font-bold  mb-2 mt-5">Recommended</h1>

      <Slider />

      <h1 className="text-3xl font-bold  mb-2 mt-5">Categories</h1>
      <div className="grid grid-cols-1 xl:grid-cols-2 auto-cols-max lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 mx-auto gap-5 ">
        <Link to="/category/rent">
          <img
            src={rentCategoryImage}
            alt="rentCategoryImage"
            className="xl:h-full xl:h-50 lg:h-56 md:h-max sm:h-max object-cover rounded-lg shadow-md"
          />
