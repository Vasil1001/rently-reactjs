      ...
      <div className="grid grid-cols-1  xl:grid-cols-3 auto-cols-max lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 mx-auto gap-5 ">
        <Link to="/category/rent">
          <img
            ...
            className="xl:h-64 lg:h-56 md:h-max sm:h-max object-cover rounded-lg shadow-md"
          />
        ...
        <Link to="/category/sale">
          <img
            ...
            className="xl:h-62 lg:h-56 md:h-max sm:h-max object-cover rounded-lg shadow-md"
          />
