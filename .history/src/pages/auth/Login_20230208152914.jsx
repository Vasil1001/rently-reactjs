    ...
    return (
        <div className="w-full max-w-md p-4 rounded-3xl border-2 border-slate-600 shadow-xl  sm:p-8 dark:bg-base-300 dark:text-gray-100">
            ...
            <div className="my-6 space-y-4">
                <button aria-label="Login with Google" type="button" className="flex items-center justify-center hover:bg-[#162142] w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2 relative">
                        ...
                        <div className="flex ">
                            ...
                            <div class="absolute inset-y-0 right-0 pr-4 pt-7 flex items-center text-sm leading-5">
                                <img style={{ text-color: 'white' }}
                                    src={visibilityIcon}
                                    alt='show password'
                                    className='showPassword stroke-cyan-500 pointer fill-white cursor-pointer'
