...
export default function Register() {
  ...
  return (
    <div className="w-full max-w-md p-4 rounded-3xl border-2 border-slate-600 shadow-xl  sm:p-8 dark:bg-base-300 dark:text-gray-100">
      <h2 className="mb-3 text-3xl font-semibold text-center">Sign up with Google</h2>
      ...
      <form className="space-y-8 ng-untouched ng-pristine ng-valid">
        ...
        <button type="button" className="w-full px-8 py-3 font-semibold rounded-md dark:bg-[#e04ced] dark:text-gray-900 hover:bg-[#ec1cff]">Sign up</button>
      </form>
