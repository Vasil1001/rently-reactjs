...
export default function Register() {
  ...
  return (
    <div className="flex w-full mx-auto items-center mt-10 max-w-md p-4 space-between rounded-3xl border-2 border-slate-600 shadow-xl  sm:p-8 dark:bg-base-300 dark:text-gray-100">
