              ...
              <input
                ...
                className={
                  !changeDetails
                    ...
                    : "bg-slate-600 mb-2 p-2 rounded-lg mt-1 focus:outline-none focus:ring ring-2 ring-orange-600  focus:border-red-500 outline outline-2 outline-offset-2 "
                }
              ...
              <input
                ...
                className={
                  !changeDetails
                    ...
                    : "bg-slate-600 mb-2 p-2 rounded-lg mt-2 outline outline-2 outline-offset-2"
                }
                disabled={!changeDetails}
                value={email}
                onChange={onChange}
