...
export default function Profile() {
  ...
  return (
    <div className="container mx-auto px-3 pb-12">
      <div className="min-w-screen text-white justify-between dark:bg-[#5270c9]">
        ...
        <div className="card shadow-xl compact side bg-[#262a31] truncate">
          <div className="flex-row items-center space-x-4 card-body">
            <div>
              <div className="avatar">
                <div className="mask mask-squircle shadow w-22 h-22">
                  <img
