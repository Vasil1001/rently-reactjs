...
export default function Profile() {
  ...
  return (
<div className="w-full mx-auto lg:w-10/12">      <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2  mb-8 md:gap-8">
        <div className="custom-card-image mb-6 md:mb-0">
          <div className="rounded-xl shadow-sm card ">
            <figure>
              <img
