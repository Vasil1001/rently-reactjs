            ...
            <form noValidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <input type="email" id="email" placeholder="username@gmail.com" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-neutral-700 dark:text-gray-100 focus:dark:border-violet-400 hover:bg-neutral-600" />
                    </div>
                    <div className="space-y-2">
