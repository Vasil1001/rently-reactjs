              ...
              <input
                ...
                className={
                  !changeDetails
                    ...
                    : "bg-slate-600 mb-2 p-2 rounded-lg mt-1 ring-1 ring-gray-400 focus:outline-none focus:ring-2  focus:ring-orange-600  focus:border-red-500  "
                }
              ...
              <input
                ...
                className={
                  !changeDetails
                    ...
                    : "bg-slate-600 mb-2 p-2 rounded-lg mt-2 ring-1 ring-gray-400 focus:outline-none focus:ring-2  focus:ring-orange-600  focus:border-red-500  ""
                }
                disabled={!changeDetails}
                value={email}
                onChange={onChange}
