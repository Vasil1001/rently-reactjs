          ...
          <div className="flex flex-col">
            ...
            <form className="flex flex-col">
              <input
                ...
                className={
                  !changeDetails
                    ? "bg-slate-700 mb-2 p-2 rounded-lg "
                    : "bg-slate-600 mb-2 p-2 rounded-lg outline outline-2 outline-offset-2 "
                }
              ...
              <input
                ...
                className={
                  !changeDetails
                    ? "bg-slate-700 mb-2 p-2 rounded-lg mt-3"
                    : "bg-slate-600 mb-2 p-2 rounded-lg mt-3 outline outline-2 outline-offset-2"
                }
                disabled={!changeDetails}
                value={email}
                onChange={onChange}
