...
export default function Profile() {
  ...
  return (
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto lg:w-10/12 mt-5">
      <div className="grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-2">
        ...
        <div className="flex flex-col col-span-2  xl:col-start-2 xl:col-span-6 lg:col-span-6  justify-between">
