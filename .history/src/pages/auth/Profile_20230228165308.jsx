      ...
      <div className="w-full rounded-lg shadow-md bg-neutral  text-slate-100 mb-5">
        <div className="grid grid-cols-5">
          <div className="flex flex-col col-span-2">
            <img
              className="rounded-lg ml-5 mt-5"
              src="https://www.w3schools.com/howto/img_avatar.png"
              alt="Image"
            />
            <div className="w-full mb-5 rounded-lg shadow-md bg-white stats text-slate-100">
              <Link to="/create-listing">
                <div className="p-5 grow h-full ">
                  <div className="flex justify-between align-center">
                    <img
                    ...
                    <div className="text-lg ml-5 mt-5 md:text-md stat-value">
                      Sell or Rent your home
                    </div>
