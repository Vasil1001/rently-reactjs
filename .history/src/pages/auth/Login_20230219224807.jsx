...
export default function Login() {
  ...
  return (
    <div className="align-center w-full max-w-md  items-center mx-auto p-4 mt-10 rounded-3xl border-2 border-slate-600 shadow-xl  sm:p-8 dark:bg-base-300 dark:text-gray-100">
