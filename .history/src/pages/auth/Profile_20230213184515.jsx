...
export default function Profile() {
  ...
  return (
    <div className="w-full mx-auto lg:w-10/12">
      <div className="container rounded-xl bg-[#2d323b] p-6 mx-auto">
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 mb-8">
          ...
          <div className="col-span-2">
            <div className="mb-6">
            <div className="flex justify-between"><button className="btn btn-outline" onClick={onLogout}>
                  Logout
                </button></div>
