  ...
  return (
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto xl:w-8/12 lg:w-12/12 md:w-12/12 mt-5">
      ...
      <div className="w-full rounded-lg text-slate-100 mb-5">
        <div className="grid grid-cols-5 grow  gap-x-6  xl:grid-cols-5 lg:grid-cols-7 md:grid-cols-5 sm:grid-cols-2">
          <div className="flex flex-col grow col-span-full xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-2">
            <img
              ...
              alt="Image"
            />
            <div className="w-full mt-5 mb-5 rounded-lg shadow-md bg-slate-600 stats text-slate-100 hover:bg-slate-700">
              <Link to="/create-listing">
                <div className="p-5 ">
                  <div className="flex justify-between align-center">
                    <img
