...
export default function Profile() {
  ...
  return (
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto xl:w-8/12 lg:w-12/12 md:w-12/12 mt-5">
      ...
      <div className="w-full h-full rounded-lg text-slate-100 mb-5">
        <div className="grid grid-cols-5  justify-between  gap-x-6  xl:grid-cols-5 lg:grid-cols-7 md:grid-cols-5 sm:grid-cols-2">
