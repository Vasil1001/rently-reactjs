...
export default function Profile() {
  ...
  return (
    <div className="container rounded-lg bg-[#2d323b] p-6 mx-auto lg:w-10/12">
      <div className="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 place-self-stretch mb-8 md:gap-8">
        <div className="max-w-72 md:w-72 mb-6  md:mb-0 shadow-sm">
          <figure>
            <img
        ...
        <div className="flex flex-col place-self-stretch col-span-2 col-start-2 col-span-10 mb-0 justify-between">
