...
export default function Login() {
  ...
  return (
    <div className="mx-auto mt-10 w-full max-w-md items-center justify-center rounded-3xl border-2 border-slate-600 p-4 shadow-xl  dark:bg-base-300 dark:text-gray-100 sm:p-8">
