...
export default function Profile() {
  ...
  return (
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto xl:w-8/12 lg:w-12/12 md:w-12/12 mt-5">
      ...
      <div className="w-full rounded-lg text-slate-100 mb-5">
        <div className="grid grid-cols-5  grid-flow-cols gap-x-6  xl:grid-cols-5 lg:grid-cols-7 md:grid-cols-5 sm:grid-cols-2">
          ...
          <div className="col-span-full   xl:col-span-3 lg:col-span-5 md:col-span-3 sm:col-span-2 justify-between">
            <div className="bg-neutral p-5 rounded-lg ">
              <div className="justify-between text-lg stat-value bg-neutral p-3 rounded-lg">
                <div className="flex ">
                  <div className="flex ">
                    <h1 className="text-2xl ">Profile </h1>
                  </div>
