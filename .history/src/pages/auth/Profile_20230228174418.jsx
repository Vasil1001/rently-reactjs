...
export default function Profile() {
  ...
  return (
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto xl:w-8/12 lg:w-12/12 md:w-12/12 mt-5">
      ...
      <div className="w-full h-full justify-between rounded-lg text-slate-100 mb-5">
        <div className="grid grid-cols-5    gap-x-6  xl:grid-cols-5 lg:grid-cols-7 md:grid-cols-5 sm:grid-cols-2">
          <div className="flex flex-col  grow justify-between col-span-full xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-2">
            <img
              className="rounded-lg"
              src="https://www.w3schools.com/howto/img_avatar.png"
              alt="Image"
            />
            <div className="w-full mt-5 mb-5 rounded-lg shadow-md bg-neutral stats text-slate-100 hover:bg-gray-700">
              <Link to="/create-listing">
                <div className="p-5 ">
                  <div className="flex justify-between align-center">
                    <img
          ...
          <div className="col-span-full   xl:col-span-3 lg:col-span-5 md:col-span-3 sm:col-span-2 justify-between">
            <div className="bg-neutral p-5 rounded-lg ">
              <div className="text-lg stat-value bg-neutral p-3 rounded-lg">
                <div className="flex justify-between ">
                  <div className="flex ">
                    <h1 className="text-2xl ">Profile </h1>
                  </div>
