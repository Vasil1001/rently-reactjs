  ...
  return (
    <div className="w-full max-w-md p-4 rounded-3xl border-2 border-slate-600 shadow-xl  sm:p-8 dark:bg-base-300 dark:text-gray-100">
      <div className="flex justify-between">
        <h2 className="mb-3 text-3xl font-semibold text-left text-gray-50">Forgot Password?</h2>
        <Link to="/login">
          <p className="focus:underline hover:underline text-sm pt-2">Back to Login</p>
        </Link>
      </div>
      <br></br>
