...
export default function Profile() {
  ...
  return (
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto xl:w-9/12 lg:w-12/12 md:w-12/12 mt-5">
      ...
      <div className="rounded-xl shadow-lg card bg-neutral  flex flex-col">
        <div className="card-body rounded-lg">
          <h2 className="text-3xl font-bold rounded-lg card-title">Listed Properties</h2>
          {!loading && listings.length !== 0 && (
            <div className="w-full py-5  mt-3 rounded-lg shadow-lg stats  p-4">
