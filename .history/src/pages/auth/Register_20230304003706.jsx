...
export default function Register() {
  ...
  return (
    <div className="space-between mx-auto mt-24 w-full max-w-md items-center rounded-3xl border-2 border-slate-600 p-4 shadow-xl  dark:bg-base-300 dark:text-gray-100 sm:p-8">
