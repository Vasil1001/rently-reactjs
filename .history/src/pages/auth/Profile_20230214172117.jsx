...
export default function Profile() {
  ...
  return (
    <div className="container rounded-lg bg-[#2d323b] p-6 mx-auto lg:w-10/12 mt-5">
      <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 auto-cols-max mb-5 md:gap-8">
        ...
        <div className="flex flex-col col-span-2 xl:col-start-2 xl:col-span-10  justify-between">
