                ...
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <input type="email" id="email" placeholder="Email" value={email}
                            onChange={onChange}
                            className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-neutral-700 dark:text-gray-100 focus:dark:border-violet-400 hover:bg-[bg-[#30333c]]" />
                    </div>
                    <div className="space-y-2">
