...
export default function Profile() {
  ...
  return (
    <div className="container rounded-lg bg-[#2d323b] p-6 mx-auto lg:w-10/12 mt-5">
      <div className="grid grid-cols-1 lg:col-span-1  xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
        <div className="xl:w-72 md:w-56 mb-6 card md:mb-0 shadow-sm">
          <figure>
            <img
        ...
        <div className="flex flex-col col-span-2 card xl:col-start-2 xl:col-span-8 lgxl:col-start-2   justify-between">
