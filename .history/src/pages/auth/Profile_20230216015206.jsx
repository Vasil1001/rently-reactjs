            ...
            <div className="grid grid-cols-2 sm:gap-1 md:gap-4 lg:gap-4 ">
              <form className="flex flex-col sm:col-span-2 md:col-span-1 lg:col-span-1 col-span-2 ">
                ...
                <input
                  ...
                  className={
                    !changeDetails
                      ? "bg-slate-700 mb-3 p-2 rounded-lg mt-0 "
                      : "bg-slate-600 mb-3 p-2 rounded-lg mt-0 ring-1 ring-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-600"
                  }
                ...
                <input
                  ...
                  className={
                    !changeDetails
                      ? "bg-slate-700 mb-3 p-2 rounded-lg "
                      : "bg-slate-600 mb-3 p-2 rounded-lg  ring-1 ring-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-600"
                  }
                  disabled={!changeDetails}
                  value={email}
                  onChange={onChange}
