      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3  mb-8 md:gap-8">
        ...
        <div className="col-span-2">
          ...
          <div className="w-full rounded-lg shadow-md bg-neutral stats text-slate-100">
              ...
              <div className="stat ">
                <div className="stat-title text-md">Bedrooms</div>
                <div className="text-lg stat-value">3</div>
              </div>

              <div className="stat ">
                <div className="stat-title text-md">Bathrooms</div>
                <div className="text-lg stat-value">2</div>
              </div>
          </div>
        </div>
      </div>
