...
export default function Login() {
    ...
    return (
        <div className='flex min-w-screen min-h-screen bg-slate-700'>
            <div className="w-full max-w-lg p-4 rounded-md shadow sm:p-8 dark:bg-neutral-900 dark:text-gray-100">
