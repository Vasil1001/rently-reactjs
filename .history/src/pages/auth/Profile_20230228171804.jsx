  ...
  return (
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto xl:w-8/12 lg:w-12/12 md:w-12/12 mt-5">
      ...
      <div className="w-full rounded-lg shadow-md bg-neutral  text-slate-100 mb-5">
        <div className="grid grid-cols-5  gap-x-6 p-5 xl:grid-cols-5 lg:grid-cols-7 md:grid-cols-5 sm:grid-cols-2">
          <div className="flex flex-col col-span-2 xl:col-span-2 lg:col-span-2 md:col-span-2 sm:col-span-2">
            <img
              className="rounded-lg"
              src="https://www.w3schools.com/howto/img_avatar.png"
              alt="Image"
            />
            <div className="w-full mt-5 mb-5 rounded-lg shadow-md bg-gray stats text-slate-100">
              <Link to="/create-listing">
                <div className="p-5 ">
                  <div className="flex justify-between align-center">
                    <img
          ...
          <div className="col-span-3 xl:col-span-3 lg:col-span-5 md:col-span-3 sm:col-span-2">
            <div className="">
              <div className="text-lg stat-value">
                <div className="flex justify-between">
                  <div className="flex">
              ...
              <div className="grid grid-cols-2 sm:gap-1 md:gap-5 lg:gap-5">
                <form className="flex flex-col sm:col-span-2 md:col-span-2 lg:col-span-2 col-span-2 ">
                  ...
                  <div className="flex gap-3">
                    <div className="w-full mt-3 mb-5 rounded-lg shadow-md bg-gray stats text-slate-100">
                      <Link to="/create-listing">
                        <div className="p-5 grow h-full ">
                          <div className="flex justify-between align-center">
                            <div className="text-lg md:text-md sm:text-sm stat-value">
