          ...
          <div className="flex flex-col">
            ...
            <form className="flex flex-col">
              <input
                ...
                className={
                  !changeDetails
                    ? "bg-slate-700 mb-2 p-3 rounded-lg "
                    : "bg-slate-600 mb-2 p-3 rounded-lg outline-3 outline-ring outline-offset-1 focus:outline-none focus:ring focus:border-green-500"
                }
              ...
              <input
                ...
                className={
                  !changeDetails
                    ? "bg-slate-700 mb-2 p-3 rounded-lg mt-3"
                    : "bg-slate-600 mb-2 p-3 rounded-lg mt-3 outline outline-2 outline-offset-2"
                }
                disabled={!changeDetails}
                value={email}
                onChange={onChange}
