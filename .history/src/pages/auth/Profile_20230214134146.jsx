...
export default function Profile() {
  ...
  return (
    <div className="container rounded-lg bg-[#2d323b] p-6 mx-auto lg:w-10/12">
      <div className="grid col-span-1 grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 place-self-stretch mb-8 md:gap-8">
        ...
        <div className="flex flex-col place-self-stretch col-span-2  mb-0 justify-between">
