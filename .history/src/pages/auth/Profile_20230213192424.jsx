...
export default function Profile() {
  ...
  return (
    <div className="container rounded-lg bg-[#2d323b] p-6 mx-auto lg:w-10/12">
      <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2  mb-3 md:gap-8">
        ...
        <div className="col-span-2 mb-3 justify-between">
      ...
      <div className="rounded-lg shadow-lg card bg-neutral">
        <div className="card-body">
          ...
          <div className="w-full py-5  mt-3 rounded-lg shadow-lg stats bg-[#2d323b] p-4">
