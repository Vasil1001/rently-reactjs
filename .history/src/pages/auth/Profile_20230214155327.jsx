...
export default function Profile() {
  ...
  return (
    <div className=" rounded-lg bg-[#2d323b] p-6 mx-auto lg:w-10/12 mt-5">
      <div className="grid lg:col-span-1  xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 mb-8 md:gap-8">
        <div className="xl:w-56 mb-6 card md:mb-0 shadow-sm">
          <figure>
            <img
        ...
        <div className="flex flex-col col-span-2  xl:col-start-2 xl:col-span6 lg:col-span-6  justify-between">
