      ...
      <form onSubmit={onSubmit} className="flex flex-col">
        ...
        <div className="flex mt-4 justify-between">
          <div>
            ...
            <button
              className="justify-end px-3 py-2 border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400 bg-orange-700 hover:bg-orange-600"
              type="number"
              id="longitude"
              value={longitude}
              onChange={onMutate}
