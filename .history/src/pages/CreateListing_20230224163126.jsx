        ...
        <div className="flex gap-5">
          ...
          <div>
            ...
            <div className="formButtons">
              <button
                className={parking ? "w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400 bg-gray-700 hover:bg-gray-600" : "formButton"}
                type="button"
                id="parking"
                value={true}
                onClick={onMutate}
