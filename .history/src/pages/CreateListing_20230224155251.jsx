...
export default function CreateListing() {
  ...
  return (
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto xl:w-11/12 lg:w-12/12 md:w-12/12 mt-5">
  
      <p className="text-xl">Create a Listing</p>
      <form onSubmit={onSubmit} className="flex flex-col">
        ...
        <div className="formRooms flex gap-5">
          <div>
