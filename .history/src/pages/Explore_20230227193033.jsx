...
export default function Explore() {
  return (
    <div className="pt-5 mx-auto xl:w-10/12 lg:w-12/12 md:w-12/12 sm:w-12/12  w-full vh-screen">
      ...
      <div className="grid grid-cols-1 justify-items-center  grid-cols-2 xl:grid-cols-4 auto-cols-max lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 mx-auto gap-5 ">
