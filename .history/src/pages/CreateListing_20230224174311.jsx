      ...
      <form onSubmit={onSubmit} className="flex flex-col">
        ...
        {!geoLocationEnabled && (
          <div className="flex gap-3">
            ...
            <div>
              <button
                className="mt-6 w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400 bg-orange-700 hover:bg-gray-600"
                type="number"
                id="longitude"
                value={longitude}
                onChange={onMutate}
