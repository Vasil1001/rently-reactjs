          ...
          <div>
            ...
            <div className="flex gap-2">
              <button
                className={
                  parking
                    ? "w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400 bg-green-700 hover:bg-gray-600 active:bg-green-600"
                    : "w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400 bg-green-700 hover:bg-gray-600"
                }
                type="button"
                id="parking"
                value={true}
