    ...
    <div className="rounded-lg bg-[#2d323b] p-6 mx-auto xl:w-10/12 lg:w-12/12 md:w-12/12 mt-5">
      ...
      <form onSubmit={onSubmit} className="flex flex-col">
        ...
        <div className="flex mt-7 flex-wrap justify-between items-end">
          ...
          <div>
            <button
              className="w-full xl:w-52 lg:w-52 lg:w-52 sm:w-52 items-end px-3 py-2 cursor-pointer border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400 bg-orange-600 hover:bg-orange-700"
              type="number"
              id="longitude"
              value={longitude}
              onChange={onMutate}
