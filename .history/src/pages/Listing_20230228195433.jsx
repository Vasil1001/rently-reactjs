      ...
      <div class="container mx-auto ">
        <section class="py-2 ">
          <div class="flex flex-wrap">
            <div class="hidden md:block md:w-3/5 px-1">
              <div
                class="h-full max-h-115 w-full bg-cover rounded shadow-md"
                style={{
                  backgroundImage:
                    "url('https://www.habituallychic.luxury/wp-content/uploads/2019/03/virginia-howard-london-flat-habituallychic-001-1024x683.jpg')",
                }}
              ></div>
            </div>
