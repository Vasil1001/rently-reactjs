    ...
    <>
      <Router>
        <div className="min-w-screen min-h-screen h-screen-vh justify-between text-white dark:bg-[#1a1b1e]">
          <Navbar />
          <div className="flex flex-col m-auto px-5 pb-12 h-screen-vh min-h-screen justify-items-center place-self-center place-items-center place-content-center xl:container">
            <Routes>
